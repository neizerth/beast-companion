import {Location} from "@/components/ui/map/Location/Location";
import S from "@/components/ui/map/GameMap/GameMap.module.scss";
...
import {addPathItem, selectPathData} from "@/store/features/path";
import {GameMode, MAX_WAIT_SIZE} from "../../../../util/common";
import {selectMode} from "@/store/features/gameMode";
import {addLocationHunter, changeLocationType, selectActiveHunters, selectLocations} from "@/store/features/locations";
import {changeLocationMeeple, injureLocationMeeple} from "@/store/features/meeple";
...
import {setCurrentHunter} from "@/store/features/hunters";
...
export const LocationList = (props: MapLocationListProps) => {
  const {
    ratio,
  } = props;
